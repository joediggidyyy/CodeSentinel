...
->
-> -> -> ->--> ->V->i->s->i->b->i->l->i->t->y->/->S->e->n->s->i->t->i->v->i->t->y-> ->(->i->n->t->e->r->n->a->l->/->e->x->t->e->r->n->a->l->,-> ->t->r->a->c->k->a->b->l->e->/->s->e->n->s->i->t->i->v->e->)->?-> ->->-> ->M->i->g->h->t-> ->r->e->q->u->i->r->e-> ->r->e->d->a->c->t->i->o->n-> ->o->r-> ->m->o->v->e-> ->t->o-> ->`->d->o->c->s->/->s->e->n->s->i->t->i->v->e->/->`->
->
